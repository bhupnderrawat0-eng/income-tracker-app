...
# ================= REPORTS =================
    ...
    with tab1:
        ...
        if collections_df.empty:
            ...
            elements.append(
                Paragraph(
                    f"<para align='center'>Generated On : {datetime.now(ZoneInfo('Asia/Kolkata')).strftime('%d-%m-%Y %I:%M %p')}</para>",
                    styles["Normal"]
                )
            )
            ...
            elements.append(
                Paragraph(
                    "<para align='center'>Mayalgaon</para>",
                    styles["Normal"]
                )
            )
            ...
            elements.append(
                Paragraph(
                    f"<para align='center'>Report Generated By : {generated_by}</para>",
                    styles["Normal"]
                )
            )
