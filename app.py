...
# ================= REPORTS =================
    ...
    with tab1:
        ...
        if collections_df.empty:
            ...
            elements.append(
                Paragraph(
                    "<para align='center'><b>Bal Yuva Mangal Dal Samiti</b></para>",
                    styles["Title"]
                )
            )
            ...
            elements.append(
                Paragraph(
                    "<para align='center'><b>Mayalgaon</b></para>",
                    styles["Heading2"]
                )
            )
            ...
            elements.append(
                Paragraph(
                    "<para align='center'>Hamara Gaon • Hamari Pehchan • Hamara Abhiyan</para>",
                    styles["Normal"]
                )
            )
            ...
            elements.append(
                Paragraph(
                    "<para align='center'><b>COLLECTIONS REPORT</b></para>",
                    styles["Heading1"]
                )
            )
            ...
            elements.append(
                Paragraph(
                    f"<para align='center'>Generated On : {datetime.now().strftime('%d-%m-%Y %I:%M %p')}</para>",
                    styles["Normal"]
                )
            )
            ...
            elements.append(
                Paragraph(
                    f"""
                    <b>Expected Total :</b> ₹ {expected_total:,.0f}
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <b>Collected :</b> ₹ {collected_total:,.0f}
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <b>Pending :</b> ₹ {pending_total:,.0f}
                    &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            elements.append(
                Paragraph(
                    "<para align='center'>Generated by Smart Finance Tracker</para>",
                    styles["Normal"]
                )
            )
