    ...
    with tab1:
        ...
        if collections_df.empty:
            ...
            with c1:
                ...
                collection_member = st.selectbox(
            ...
            if pending_filter == "Paid":

                filtered_df = filtered_df[
                    filtered_df["amount"] > 0
                ]

            if pending_filter == "Pending":
